  ...
  return (
    <div className="grid gap-4 p-4 sm:p-6 border border-gray-200 rounded-2xl bg-white">
      ...
      <div className="grid items-center gap-8 relative">
        <div className="w-px h-full absolute top-1 left-[1.1rem] sm:left-[1.45rem] bg-gray-200" />
        <div className="flex w-full relative gap-4 pl-2 sm:pl-3.5 items-start">
          <div className="rounded-full bg-gray-100 p-1 text-gray-600 [&>svg]:size-2.5 size-5 flex items-center justify-center shrink-0 translate-y-1">
            <ArrowUpRight />
          </div>
          <div>
            <div className="text-2xl font-medium">{departingAirportCode}</div>
            <div>{departingAirport}</div>
            <div className="text-sm text-gray-600">터미널 1 · 게이트 15</div>
          </div>
          <div className="ml-auto font-mono">
            <div className="text-lg md:text-xl">{departingTime}</div>
            <div className="text-sm text-gray-600">정시 출발</div>
          </div>
        </div>
        <div className="flex w-full relative gap-4 pl-2 sm:pl-3.5 min-h-10 items-center">
          <div className="rounded-full bg-gray-100 p-1 text-gray-600 [&>svg]:size-2.5 size-5 flex items-center justify-center shrink-0">
            <Check />
          </div>
          <div className="text-sm sm:text-base text-gray-600">총 2시간 50분 · 1,157km</div>
        </div>
        <div className="flex w-full relative gap-4 pl-2 sm:pl-3.5 items-start">
          <div className="rounded-full bg-gray-100 p-1 text-gray-600 [&>svg]:size-2.5 size-5 flex items-center justify-center shrink-0 translate-y-1">
            <ArrowDownRight />
          ...
          <div>
            ...
            <div className="text-sm text-gray-600">터미널 3 · 게이트 26</div>
          </div>
          <div className="ml-auto font-mono">
            <div className="text-lg md:text-xl">{arrivalTime}</div>
            <div className="text-sm text-gray-600">정시 도착 예정</div>
          </div>
        </div>
      </div>
