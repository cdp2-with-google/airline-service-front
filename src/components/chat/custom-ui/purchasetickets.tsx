  ...
  return (
    <div className="grid gap-4 p-4 sm:p-6 border border-purple-200 rounded-2xl bg-white">
      <div className="flex justify-between items-center">
        ...
        <div className="text-sm flex items-center gap-1 border border-purple-200 px-3 py-1 rounded-full text-purple-700">
      ...
      {currentStatus === 'requires_confirmation' && (
        <div className="flex flex-col gap-4">
          ...
          <button
            className="p-2 text-center rounded-full cursor-pointer bg-purple-600 text-white hover:bg-purple-700 transition-colors"
      ...
      {currentStatus === 'requires_code' && (
        <>
          <div className="text-purple-700">구매를 완료하려면 휴대폰 (***) *** 6137로 전송된 코드를 입력하세요.</div>
          <div className="flex justify-center p-2 text-center border rounded-full text-purple-700">
            <input
